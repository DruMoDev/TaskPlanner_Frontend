          ...
          <div className="flex justify-between mb-10 items-center">
            ...
            <div className="w-1/4 flex gap-5">
              <button
                ...
                className="rounded-full w-24 bg-sky-600 font-semiboldbold text-sm  flex text-white items-center justify-center font-bold hover:bg-sky-700 transition-colors  h-12"
              >
                {/* Colaborador{" "} */}
                <svg
              ...
              <button
                onClick={onOpen}
                className="rounded-full w-24 h-12 bg-sky-600 font-semiboldbold  flex text-white items-center justify-center uppercase font-bold hover:bg-sky-700 transition-colors"
              >
                <svg
                  viewBox="0 0 1024 1024"
                  fill="currentColor"
              ...
              <button
                className="rounded-full w-24 bg-red-600 font-semiboldbold text-white  flex items-center justify-center uppercase font-bold hover:bg-red-700 transition-colors h-12"
